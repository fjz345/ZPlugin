...
#include "ZPreviewerInteractiveTool.generated.h"


/**
 * Builder for UZPreviewerInteractiveTool
 */
UCLASS()
class ZPREVIEWER_API UZPreviewerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UZPreviewerInteractiveTool
 */
UCLASS(Transient)
class ZPREVIEWER_API UZPreviewerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UZPreviewerInteractiveToolProperties();
...
/**
 * UZPreviewerInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ZPREVIEWER_API UZPreviewerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UZPreviewerInteractiveToolProperties> Properties;
