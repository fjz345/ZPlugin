...
#include "ZPreviewerInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UZPreviewerInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UZPreviewerInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UZPreviewerInteractiveTool* NewTool = NewObject<UZPreviewerInteractiveTool>(SceneState.ToolManager);
...
UZPreviewerInteractiveToolProperties::UZPreviewerInteractiveToolProperties()
{
...
void UZPreviewerInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UZPreviewerInteractiveTool::Setup()
{
	...
	Properties = NewObject<UZPreviewerInteractiveToolProperties>(this, "Measurement");
...
void UZPreviewerInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UZPreviewerInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UZPreviewerInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UZPreviewerInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UZPreviewerInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UZPreviewerInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UZPreviewerInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UZPreviewerInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UZPreviewerInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
